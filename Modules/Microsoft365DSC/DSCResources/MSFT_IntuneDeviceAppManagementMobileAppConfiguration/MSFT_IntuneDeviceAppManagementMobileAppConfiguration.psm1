...
function Set-TargetResource
{
    ...
    if ($Ensure -eq 'Present' -and $currentAppConfiguration.Ensure -eq 'Absent')
    {
        ...
        $AdditionalProperties = Get-M365DSCIntuneDeviceAppManagementMobileAppConfigurationAdditionalProperties -Properties ([System.Collections.Hashtable]$PSBoundParameters)
...
function Get-M365DSCIntuneDeviceAppManagementMobileAppConfigurationAdditionalProperties
{
    [CmdletBinding()]
    [OutputType([System.Collections.Hashtable])]
    param(
